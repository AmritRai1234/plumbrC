...
# Link gRPC server — static link to avoid ABI mismatch between builder/runner Alpine versions
# Builder is Alpine 3.19 (grpc 1.59.3), runner is node:20-alpine (grpc 1.76.0+)
GRPC_LDFLAGS = -static $(shell pkg-config --libs --static grpc++ protobuf 2>/dev/null || echo "-lgrpc++ -lgrpc -lgpr -lprotobuf -lupb -laddress_sorting -lre2 -lcares -lz -lssl -lcrypto -labsl_status -labsl_statusor -labsl_str_format_internal -labsl_synchronization -labsl_time -labsl_time_zone -labsl_strings -labsl_strings_internal -labsl_int128 -labsl_base -labsl_spinlock_wait -labsl_throw_delegate -labsl_raw_logging_internal -labsl_log_severity -labsl_cord -labsl_cordz_info -labsl_cord_internal -labsl_cordz_functions -labsl_cordz_handle -labsl_exponential_biased -labsl_hash -labsl_city -labsl_low_level_hash -labsl_raw_hash_set -labsl_hashtablez_sampler -labsl_strerror -labsl_symbolize -labsl_stacktrace -labsl_debugging_internal -labsl_demangle_internal -labsl_malloc_internal -labsl_examine_stack") -lpcre2-8
